...
export function timePicker_create(input) {
...
export function timePickerModal_create(input) {
...
// CONCATENATED MODULE: ./src/init/timePickerInput.ts
            ...
            export function createModals(element) {
                console.log("test")
            }
...
export function timePickerInput_create(input) {
    ...
    var displayModal = function () {
        ...
        modal.onDispose(function () {
            const timeChangedEvent = new CustomEvent('timeChanged', {
                detail: {
                    mode: mode
                },
                bubbles: true
            });
            el.dispatchEvent(timeChangedEvent);
            console.log("dispose");
            return modal = null;
        });
    };
