!function t(e, n, r) {
    ...
    1: [function (t, e, n) {
        ...
        !function (t) {
            ...
            function n(t, e, n) {
                if (window.CustomEvent) var r = new CustomEvent(e, {detail: n}); else {
            ...
            var r = {rulerClassName: "bricklayer-column-sizer", columnClassName: "bricklayer-column"}, i = function () {
                function t(t) {
                ...
                return o(e, t), e.prototype.getWidth = function () {
                ...
                function t(t, e) {
                    ...
                    // Add flag to track if class is added
                ...
                return t.prototype.append = function (t) {
                    ...
                    var t = e(this.getColumns()), n = t.map(function (t) {
                    ...
                    for (var r = e(this.elements).map(function (t) {
                        ...
                        return e
                    }), o = this.getColumns(), i = 0; i < o.length; i++) o[i].parentNode.removeChild(o[i]);

                    // Determine if we need to add or remove the class based on the number of columns
                    if (t > 1 && !this.classAdded) {
                        r.forEach(function (element) {
                            element.classList.add("reordered");
                        });
                        this.classAdded = true;
                    } else if (t <= 1 && this.classAdded) {
                        r.forEach(function (element) {
                            element.classList.remove("reordered");
                        });
                        this.classAdded = false;
                    }
                    for (var i = 0; t > i; i++) {
                    ...
                    var t = this.element.offsetWidth, e = this.ruler.getWidth();
